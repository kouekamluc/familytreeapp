...
class _HeritageVaultViewState extends State<HeritageVaultView> {
  ...
  void _copyToClipboard(String key) {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        ...
        content: Row(
          children: [
            const Icon(Icons.check_circle_rounded, color: RoyalTheme.brightGold, size: 20),
            ...
            child: Column(
              ...
              children: [
                  ...
                  children: [
                    Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        border: Border.all(color: RoyalTheme.brightGold.withValues(alpha: 0.5)),
                      ),
                      child: const Icon(Icons.vpn_key_rounded, color: RoyalTheme.brightGold, size: 22),
                    ),
                ...
                DropdownButtonFormField<String>(
                  ...
                  dropdownColor: isDark ? const Color(0xFF1A1C26) : Colors.white,
                  items: const [
                    DropdownMenuItem(value: 'FAMILY_MEMBER', child: Text('👤 Membre de la Famille (Consultation)', overflow: TextOverflow.ellipsis)),
                    DropdownMenuItem(value: 'ROYAL_PATRIARCH', child: Text('🏛️ Patriarche / Ancien (Sagesse)', overflow: TextOverflow.ellipsis)),
                    DropdownMenuItem(value: 'CURATOR', child: Text('👑 Curateur / Administrateur (Gestion)', overflow: TextOverflow.ellipsis)),
                  ],
                  onChanged: (val) {
                ...
                child: RoyalButton(
                  ...
                  onPressed: () async {
                    ...
                    final created = await auth.generateHeritageKey(
                      name: nameCtrl.text.trim().isEmpty ? 'Clé Royale' : nameCtrl.text.trim(),
                      role: selectedRole,
                    );
  ...
  Widget build(BuildContext context) {
    ...
    // Primary active key
    final activeKey = keys.isNotEmpty
        ? keys.firstWhere((k) => k.isActive, orElse: () => keys.first)
        : HeritageKey(
            id: 1,
            key: 'KKEVO-ROYAL-2026-ROOT',
            name: 'Clé Royale Racine',
            role: 'CURATOR',
            isActive: true,
            usageCount: 14,
          ...
          children: [
            ...
            Container(
              ...
              decoration: BoxDecoration(
                ...
                boxShadow: [
                  BoxShadow(
                    color: RoyalTheme.brightGold.withValues(alpha: isDark ? 0.2 : 0.1),
                    blurRadius: 20,
                  ...
                  Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        IconButton(
                          icon: Icon(
                            _copiedKey == activeKey.key ? Icons.check_rounded : Icons.copy_rounded,
                            color: RoyalTheme.brightGold,
                            size: 20,
                          ),
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      ElevatedButton.icon(
                        ...
                        label: const Text('Partager', style: TextStyle(fontSize: 12, fontWeight: FontWeight.bold)),
                        ...
                        onPressed: () {
                          ...
                          Clipboard.setData(ClipboardData(
                            text: 'Rejoins la généalogie de la Famille Kkevo ! Utilise ta clé d\'accès exclusive : ${activeKey.key}',
                          ));
                          ScaffoldMessenger.of(context).showSnackBar(
                            SnackBar(
                              behavior: SnackBarBehavior.floating,
                              backgroundColor: const Color(0xFF1E212B),
                              content: const Text('Invitation avec clé copiée ! Partagez-la par SMS / WhatsApp.'),
                            ),
                          );
                        },
                      ),
            ...
            Row(
              ...
              children: [
                ...
                TextButton.icon(
                  ...
                  icon: const Icon(Icons.add_circle_outline, size: 16, color: RoyalTheme.brightGold),
                  label: Text(
                    'Nouvelle Clé',
                    style: GoogleFonts.inter(
                      fontSize: 13,
            ...
            if (auth.isLoadingKeys)
              ...
              Center(
                child: Padding(
                  ...
                  child: Column(
                    children: [
                      Icon(Icons.key_off_outlined, size: 48, color: Colors.grey.withValues(alpha: 0.5)),
                      const SizedBox(height: 12),
                      const Text(
                        'Aucune clé active.',
          ...
          Row(
            ...
            children: [
              Row(
                children: [
                  Icon(
                    keyItem.isActive ? Icons.vpn_key_rounded : Icons.key_off_rounded,
                    color: keyItem.isActive ? RoyalTheme.brightGold : Colors.grey,
                    size: 18,
                  ),
              ...
              Container(
                ...
                child: Text(
                  ...
                  style: TextStyle(
                    color: keyItem.isActive ? Colors.greenAccent : Colors.redAccent,
                    fontSize: 11,
              ...
              children: [
                ...
                InkWell(
                  ...
                  child: Padding(
                    ...
                    child: Icon(
                      _copiedKey == keyItem.key ? Icons.check_circle_rounded : Icons.copy_rounded,
                      size: 16,
                      color: RoyalTheme.brightGold,
                    ),
                  ),
                  ...
                  onPressed: () async {
                    ...
                    final confirm = await showDialog<bool>(
                      ...
                      builder: (ctx) => AlertDialog(
                        backgroundColor: isDark ? const Color(0xFF1A1C26) : Colors.white,
                        title: const Text('Révoquer cette clé ?'),
                        content: Text(
                          'Les membres utilisant ${keyItem.key} ne pourront plus se connecter avec ce passkey.',
                        ),
                        actions: [
                          TextButton(onPressed: () => Navigator.pop(ctx, false), child: const Text('Annuler')),
                          TextButton(
                            onPressed: () => Navigator.pop(ctx, true),
                            child: const Text('Révoquer', style: TextStyle(color: Colors.redAccent)),
                          ),
                        ],
                      ),
                    );
