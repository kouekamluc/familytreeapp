...
class _LoginViewState extends State<LoginView> {
  ...
  final _heritageKeyController = TextEditingController(text: 'KKEVO-ROYAL-2026-ROOT');
          ...
          SnackBar(
            ...
            content: Row(
              children: [
                ...
                Expanded(
                  child: Text(
                    auth.errorMessage ?? 'Identifiants invalides. Veuillez vérifier vos accès.',
                    style: const TextStyle(color: Colors.white, fontWeight: FontWeight.w600),
                  ),
                ),
              ],
                  ...
                  Container(
                    ...
                    child: Row(
                      children: [
                              ...
                              decoration: BoxDecoration(
                                gradient: _useHeritageKey
                                    ? const LinearGradient(
                                        colors: [Color(0xFFB8860B), Color(0xFFFFD700), Color(0xFFC5A059)],
                                      )
                                    : null,
                                borderRadius: BorderRadius.circular(10),
                              ),
                              child: Row(
                                ...
                                children: [
                                  Icon(
                                    Icons.key_rounded,
                                    size: 16,
                                    color: _useHeritageKey ? Colors.black : (isDark ? Colors.grey[400] : Colors.grey[700]),
                                  ),
                        ...
                        Expanded(
                          child: InkWell(
                            onTap: () => setState(() => _useHeritageKey = false),
                            borderRadius: BorderRadius.circular(10),
                            child: Container(
                              padding: const EdgeInsets.symmetric(vertical: 8),
                              decoration: BoxDecoration(
                        ...
                        children: [
                          Row(
                            ...
                            children: [
                              ...
                              InkWell(
                                ...
                                child: const Text(
                                  '📋 Paste',
                                  style: TextStyle(fontSize: 11, color: RoyalTheme.brightGold, fontWeight: FontWeight.bold),
                                ),
                              ),
                            ],
                          ),
                          ...
                          TextFormField(
                            ...
                            decoration: InputDecoration(
                              prefixIcon: const Icon(Icons.vpn_key_rounded, color: RoyalTheme.brightGold, size: 18),
                          ...
                          Wrap(
                            ...
                            children: [
                              ActionChip(
                                label: const Text('👑 KKEVO-ROYAL-2026-ROOT', style: TextStyle(fontSize: 10, fontWeight: FontWeight.bold)),
                                backgroundColor: isDark ? Colors.white.withValues(alpha: 0.05) : Colors.black.withValues(alpha: 0.04),
                                side: BorderSide(color: RoyalTheme.brightGold.withValues(alpha: 0.3)),
                                onPressed: () => setState(() => _heritageKeyController.text = 'KKEVO-ROYAL-2026-ROOT'),
                              ),
                              ActionChip(
                                label: const Text('🏛️ KKEVO-ELDER-7777', style: TextStyle(fontSize: 10, fontWeight: FontWeight.bold)),
                                backgroundColor: isDark ? Colors.white.withValues(alpha: 0.05) : Colors.black.withValues(alpha: 0.04),
                                side: BorderSide(color: RoyalTheme.brightGold.withValues(alpha: 0.3)),
                                onPressed: () => setState(() => _heritageKeyController.text = 'KKEVO-ELDER-7777'),
                              ),
                            ],
                          ),
                          ...
                          SizedBox(
                            ...
                            child: ElevatedButton(
                              ...
                              onPressed: auth.isLoading ? null : _handleHeritageKeyLogin,
                  ...
                  SizedBox(
                    ...
                    child: OutlinedButton.icon(
                      ...
                      label: const Text(
                        ...
                        style: TextStyle(color: RoyalTheme.brightGold, fontWeight: FontWeight.bold, fontSize: 13),
                      ),
